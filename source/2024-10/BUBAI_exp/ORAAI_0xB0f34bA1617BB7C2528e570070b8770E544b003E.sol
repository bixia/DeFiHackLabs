...
Website: https://oraai.xyz/
Telegram: https://t.me/oraai_eth
Twitter: https://x.com/oraai_eth
...
contract ORAAI is Context, IERC20, Ownable {
    ...
    uint256 private _firstTaxBuy=5;
    uint256 private _firstTaxSell=5;

    uint256 private _finalTaxBuy=1;
    uint256 private _finalTaxSell=1;
    ...
    string private constant _name = unicode"Ora AI";
    string private constant _symbol = unicode"ORAAI";

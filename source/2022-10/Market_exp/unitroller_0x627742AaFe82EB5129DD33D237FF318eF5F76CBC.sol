...
contract CToken is CTokenInterface, Exponential, TokenErrorReporter {
    ...
    function initialize(ComptrollerInterface comptroller_,
        ...
        require(err == uint(Error.NO_ERROR), "setting cmp fail");
        ...
        require(err == uint(Error.NO_ERROR), "set irm fail");
        ...
        require(err == uint(Error.NO_ERROR), "set reserve factor fail");

        // Set admin fee
        err = _setAdminFeeFresh(adminFeeMantissa_);
        require(err == uint(Error.NO_ERROR), "set admin fee fail");
    ...
    function accrueInterest() public returns (uint) {
        ...
        require(borrowRateMantissa <= borrowRateMaxMantissa, "borrow rate > max");
    ...
    function _withdrawAdminFeesFresh(uint withdrawAmount) internal returns (uint) {
        ...
        require(UnitrollerAdminStorage(address(comptroller)).admin() == msg.sender, "!admin");
    ...
    function _setInterestRateModelFresh(InterestRateModel newInterestRateModel) internal returns (uint) {
        ...
        require(newInterestRateModel.isInterestRateModel(), "!isInterestRateModel");

...
pragma solidity =0.6.8 >=0.6.8 ^0.6.0 ^0.6.2 ^0.6.8;
...
abstract contract BaseChain is Registrable, Ownable {
  ...
  using Decoder for uint224; // TODO change this to `ValueDecoder` once solution will be in SDK
  ...
  // TODO once Decoder will be merged into SDK, move this method and tests to SDK as well

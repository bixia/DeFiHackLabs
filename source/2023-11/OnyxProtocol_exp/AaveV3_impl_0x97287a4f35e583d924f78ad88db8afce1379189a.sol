...
library ReserveConfiguration {
  ...
  function setLtv(DataTypes.ReserveConfigurationMap memory self, uint256 ltv) internal pure {
    require(ltv <= MAX_VALID_LTV, Errors_1.InvalidLtv());
  ...
  function setLiquidationThreshold(
    ...
    require(threshold <= MAX_VALID_LIQUIDATION_THRESHOLD, Errors_1.InvalidLiquidationThreshold());
  ...
  function setLiquidationBonus(
    ...
    require(bonus <= MAX_VALID_LIQUIDATION_BONUS, Errors_1.InvalidLiquidationBonus());
  ...
  function setDecimals(
    ...
    require(decimals <= MAX_VALID_DECIMALS, Errors_1.InvalidDecimals());
  ...
  function setReserveFactor(
    ...
    require(reserveFactor <= MAX_VALID_RESERVE_FACTOR, Errors_1.InvalidReserveFactor());
  ...
  function setBorrowCap(
    ...
    require(borrowCap <= MAX_VALID_BORROW_CAP, Errors_1.InvalidBorrowCap());
  ...
  function setSupplyCap(
    ...
    require(supplyCap <= MAX_VALID_SUPPLY_CAP, Errors_1.InvalidSupplyCap());
  ...
  function setDebtCeiling(
    ...
    require(ceiling <= MAX_VALID_DEBT_CEILING, Errors_1.InvalidDebtCeiling());
  ...
  function setLiquidationProtocolFee(
    ...
    require(
      ...
      Errors_1.InvalidLiquidationProtocolFee()
    );
...
library EModeConfiguration {
  ...
  function setReserveBitmapBit(
    ...
    unchecked {
      require(reserveIndex < ReserveConfiguration.MAX_RESERVES_COUNT, Errors_1.InvalidReserveIndex());
 ...
 */
abstract contract Multicall is Context_0 {
    /**
    ...
    function multicall(bytes[] calldata data) external virtual returns (bytes[] memory results) {
        ...
        for (uint256 i = 0; i < data.length; i++) {
            results[i] = Address_1.functionDelegateCall(address(this), bytes.concat(data[i], context));
        }
        return results;
    }
}
  ...
  function increaseIsolatedDebtIfIsolated(
    ...
    if (isolationModeActive) {
      ...
      require(
        ...
        Errors_1.AssetNotBorrowableInIsolation()
      );
      ...
      require(nextIsolationModeTotalDebt <= isolationModeDebtCeiling, Errors_1.DebtCeilingExceeded());
 ...
 */
abstract contract IncentivizedERC20 is Context_1, IERC20Detailed {
  using WadRayMath for uint256;
  using SafeCast for uint256;
  ...
  modifier onlyPoolAdmin() {
    ...
    require(aclManager.isPoolAdmin(_msgSender()), Errors_1.CallerNotPoolAdmin());
    _;
  }
   ...
   */
  modifier onlyPool() {
    require(_msgSender() == address(POOL), Errors_1.CallerMustBePool());
    _;
  }
...
library ReserveLogic {
  ...
  function init(
    ...
    require(reserve.aTokenAddress == address(0), Errors_1.ReserveAlreadyInitialized());
...
library ValidationLogic {
  ...
  function validateSupply(
    ...
    require(scaledAmount != 0, Errors_1.InvalidAmount());

    (bool isActive, bool isFrozen, , bool isPaused) = reserveCache.reserveConfiguration.getFlags();
    require(isActive, Errors_1.ReserveInactive());
    require(!isPaused, Errors_1.ReservePaused());
    require(!isFrozen, Errors_1.ReserveFrozen());
    require(onBehalfOf != reserveCache.aTokenAddress, Errors_1.SupplyToAToken());
  ...
  function validateWithdraw(
    ...
    require(scaledAmount != 0, Errors_1.InvalidAmount());
    require(scaledAmount <= scaledUserBalance, Errors_1.NotEnoughAvailableUserBalance());
  ...
  function validateBorrow(
    ...
    require(params.amountScaled != 0, Errors_1.InvalidAmount());
    ...
    require(vars.isActive, Errors_1.ReserveInactive());
    require(!vars.isPaused, Errors_1.ReservePaused());
    require(!vars.isFrozen, Errors_1.ReserveFrozen());
    require(vars.borrowingEnabled, Errors_1.BorrowingNotEnabled());
    require(
      IERC20(params.reserveCache.aTokenAddress).totalSupply() >= vars.amount,
      Errors_1.InvalidAmount()
    );

    require(
      params.priceOracleSentinel == address(0) ||
        IPriceOracleSentinel(params.priceOracleSentinel).isBorrowAllowed(),
      Errors_1.PriceOracleSentinelCheckFailed()
    );

    //validate interest rate mode
    require(
      params.interestRateMode == DataTypes.InterestRateMode.VARIABLE,
      Errors_1.InvalidInterestRateModeSelected()
    );
    ...
    if (vars.borrowCap != 0) {
      ...
      unchecked {
        require(vars.totalDebt <= vars.borrowCap * vars.assetUnit, Errors_1.BorrowCapExceeded());
      }
    }
    ...
    if (params.userConfig.isBorrowingAny()) {
      ...
      if (vars.siloedBorrowingEnabled) {
        require(vars.siloedBorrowingAddress == params.asset, Errors_1.SiloedBorrowingViolation());
      } else {
        require(
          !params.reserveCache.reserveConfiguration.getSiloedBorrowing(),
          Errors_1.SiloedBorrowingViolation()
        );
      }
    }
  }
  ...
  function validateRepay(
    ...
    require(amountSent != 0, Errors_1.InvalidAmount());
    require(
    ...
    require(
      ...
      Errors_1.NoExplicitAmountToRepayOnBehalf()
    );
    ...
    require(debtScaled != 0, Errors_1.NoDebtOfSelectedType());
  }
  ...
  function validateFlashloan(
    ...
    require(assets.length == amounts.length, Errors_1.InconsistentFlashloanParams());
    for (uint256 i = 0; i < assets.length; i++) {
      for (uint256 j = i + 1; j < assets.length; j++) {
        require(assets[i] != assets[j], Errors_1.InconsistentFlashloanParams());
      }
  ...
  function validateFlashloanSimple(
    ...
    require(!configuration.getPaused(), Errors_1.ReservePaused());
    require(configuration.getActive(), Errors_1.ReserveInactive());
    require(configuration.getFlashLoanEnabled(), Errors_1.FlashloanDisabled());
    require(IERC20(reserve.aTokenAddress).totalSupply() >= amount, Errors_1.InvalidAmount());
  }
  ...
  function validateLiquidationCall(
    ...
    require(params.borrower != params.liquidator, Errors_1.SelfLiquidation());
    ...
    require(vars.collateralReserveActive && vars.principalReserveActive, Errors_1.ReserveInactive());
    require(!vars.collateralReservePaused && !vars.principalReservePaused, Errors_1.ReservePaused());
    ...
    require(
      ...
      Errors_1.LiquidationGraceSentinelCheckFailed()
    );

    require(
      params.healthFactor < HEALTH_FACTOR_LIQUIDATION_THRESHOLD,
      Errors_1.HealthFactorNotBelowThreshold()
    );
    ...
    require(vars.isCollateralEnabled, Errors_1.CollateralCannotBeLiquidated());
    require(params.totalDebt != 0, Errors_1.SpecifiedCurrencyNotBorrowedByUser());
  }
  ...
  function validateHealthFactor(
    ...
    require(
      ...
      Errors_1.HealthFactorLowerThanLiquidationThreshold()
    );
  ...
  function validateHFAndLtv(
    ...
    require(currentLtv != 0, Errors_1.LtvValidationFailed());
    ...
    require(
      ...
      Errors_1.CollateralCannotCoverNewBorrow()
    );
  }
  ...
  function validateTransfer(DataTypes.ReserveData storage reserve) internal view {
    require(!reserve.configuration.getPaused(), Errors_1.ReservePaused());
  }
  ...
  function validateDropReserve(
    ...
    require(asset != address(0), Errors_1.ZeroAddressNotValid());
    require(reserve.id != 0 || reservesList[0] == asset, Errors_1.AssetNotListed());
    require(
      IERC20(reserve.variableDebtTokenAddress).totalSupply() == 0,
      Errors_1.VariableDebtSupplyNotZero()
    );
    require(
      IERC20(reserve.aTokenAddress).totalSupply() == 0 && reserve.accruedToTreasury == 0,
      Errors_1.UnderlyingClaimableRightsNotZero()
    );
  }
  ...
  function validateSetUserEMode(
    ...
    require(
      ...
      Errors_1.InconsistentEModeCategory()
    );
...
library SupplyLogic {
  ...
  function executeWithdraw(
    ...
    require(params.to != reserveCache.aTokenAddress, Errors_1.WithdrawToAToken());
  ...
  function executeUseReserveAsCollateral(
    ...
    if (useAsCollateral) {
      ...
      require(
        ...
        Errors_1.UnderlyingBalanceZero()
      );
      ...
      require(
        ...
        Errors_1.UserInIsolationModeOrLtvZero()
      );
...
library LiquidationLogic {
  ...
  function executeEliminateDeficit(
    ...
    require(params.amount != 0, Errors_1.InvalidAmount());

    DataTypes.ReserveData storage reserve = reservesData[params.asset];
    uint256 currentDeficit = reserve.deficit;

    require(currentDeficit != 0, Errors_1.ReserveNotInDeficit());
    require(!userConfig.isBorrowingAny(), Errors_1.UserCannotHaveDebt());
    ...
    require(scaledBalanceWriteOff <= userScaledBalance, Errors_1.NotEnoughAvailableUserBalance());
...
library PoolLogic {
  ...
  function executeInitReserve(
    ...
    require(Address_0.isContract(params.asset), Errors_1.NotContract());
    ...
    require(!reserveAlreadyAdded, Errors_1.ReserveAlreadyAdded());
    ...
    require(params.reservesCount < params.maxNumberReserves, Errors_1.NoMoreReservesAllowed());
  ...
  function executeResetIsolationModeTotalDebt(
    ...
    require(reservesData[asset].configuration.getDebtCeiling() == 0, Errors_1.DebtCeilingNotZero());
...
library FlashLoanLogic {
  ...
  function executeFlashLoan(
    ...
    require(
      ...
      Errors_1.InvalidFlashloanExecutorReturn()
    );
...
abstract contract Pool is VersionedInitializable, PoolStorage, IPool, Multicall {
  ...
  modifier onlyUmbrella() {
    require(ADDRESSES_PROVIDER.getAddress(UMBRELLA) == _msgSender(), Errors_1.CallerNotUmbrella());
    _;
  }
  ...
  function _onlyPoolConfigurator() internal view virtual {
    require(
      ...
      Errors_1.CallerNotPoolConfigurator()
    );
  }
  ...
  function _onlyPoolAdmin() internal view virtual {
    require(
      ...
      Errors_1.CallerNotPoolAdmin()
    );
  }

  function _onlyPositionManager(address onBehalfOf) internal view virtual {
    require(_positionManager[onBehalfOf][_msgSender()], Errors_1.CallerNotPositionManager());
  }
  ...
  constructor(IPoolAddressesProvider provider, IReserveInterestRateStrategy interestRateStrategy) {
    ...
    require(address(interestRateStrategy) != address(0), Errors_1.ZeroAddressNotValid());
  ...
  function finalizeTransfer(
    ...
    require(_msgSender() == _reserves[asset].aTokenAddress, Errors_1.CallerNotAToken());
  ...
  function setConfiguration(
    ...
    require(asset != address(0), Errors_1.ZeroAddressNotValid());
    require(_reserves[asset].id != 0 || _reservesList[0] == asset, Errors_1.AssetNotListed());
  ...
  function configureEModeCategory(
    ...
    require(id != 0, Errors_1.EModeCategoryReserved());
...
contract PoolInstance is Pool {
  ...
  function initialize(IPoolAddressesProvider provider) external virtual override initializer {
    require(provider == ADDRESSES_PROVIDER, Errors_1.InvalidAddressesProvider());
  }

...
pragma solidity <0.9.0 =0.8.21 >=0.5.0 >=0.6.0 >=0.7.6 >=0.8.0 ^0.8.0;
...
// @layerzerolabs/solidity-examples/contracts/token/oft/IOFT.sol
...
// @layerzerolabs/solidity-examples/contracts/token/oft/OFT.sol
...
// @layerzerolabs/solidity-examples/contracts/token/oft/extension/BasedOFT.sol

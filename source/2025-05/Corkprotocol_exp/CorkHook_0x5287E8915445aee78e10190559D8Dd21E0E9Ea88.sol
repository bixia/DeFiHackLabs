pragma solidity =0.8.26 >=0.8.19 ^0.8.0 ^0.8.20 ^0.8.24;
...
// lib/Cork-Hook/lib/Depeg-swap/contracts/interfaces/IErrors.sol
 ...
 */
interface IExpiry is IErrors_0 {
...
library SwapMath {
        ...
        returns (UD60x18 amountOut, UD60x18 fee)
    {
        ...
        UD60x18 feeFactor = mul_1(baseFee, sub_2(convert_1(1), _1MinT));
        ...
        q = pow_1(q, _1MinT);
        q = pow_1(sub_2(k, q), div_1(convert_1(1), _1MinT));
        ...
        returns (UD60x18 amountIn, UD60x18 fee)
    {
        ...
        UD60x18 feeFactor = div_1(mul_1(baseFee, sub_2(convert_1(1), _1MinT)), convert_1(100));
        feeFactor = sub_2(convert_1(1), feeFactor);
        ...
        returns (UD60x18 t)
    {
        ...
        t = sub_2(convert_1(1), div_1(elapsedTime, totalDuration));
    }
    ...
    function _oneMinusT(uint256 startTime, uint256 maturityTime, uint256 currentTime) internal pure returns (uint256) {
        return unwrap_5(sub_2(convert_1(1), _getNormalizedTimeToMaturity(ud(startTime), ud(maturityTime), ud(currentTime))));
    }
    ...
    function _calculatePercentage(UD60x18 amount, UD60x18 percentage) internal pure returns (UD60x18 result) {
        result = div_1(mul_1(amount, percentage), convert_1(100));
    }
...
interface ICorkHook is IErrors_1 {

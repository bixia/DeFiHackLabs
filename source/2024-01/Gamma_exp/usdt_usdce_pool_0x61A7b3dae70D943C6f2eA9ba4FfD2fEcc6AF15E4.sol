...
pragma solidity <0.8.0 =0.7.6 >=0.4.0 >=0.5.0 >=0.6.0 >=0.6.2 >=0.6.5;
pragma abicoder v2;
...
// contracts/algebra/interfaces/callback/IAlgebraMintCallback.sol
...
// contracts/algebra/libraries/TickMath.sol

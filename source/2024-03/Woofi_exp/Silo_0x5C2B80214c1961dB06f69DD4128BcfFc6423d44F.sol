...
pragma solidity <0.9.0 =0.8.13 >=0.7.6 ^0.8.0;
...
library Solvency {
    ...
    struct SolvencyParams {
        ...
        IBaseSilo.AssetStorage[] assetStates;
    ...
    function getUserCollateralAmount(
        IBaseSilo.AssetStorage memory _assetStates,
    ...
    function getUserBorrowAmount(IBaseSilo.AssetStorage memory _assetStates, address _user, uint256 _rcomp)
        internal
        view
        returns (uint256)
    {

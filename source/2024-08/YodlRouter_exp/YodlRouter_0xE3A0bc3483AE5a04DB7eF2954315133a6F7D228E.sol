...
pragma solidity >=0.5.0 >=0.6.0 >=0.7.5 >=0.7.6 ^0.8.0 ^0.8.20 ^0.8.26;
pragma abicoder v2;
...
// lib/swap-router-contracts/contracts/interfaces/IApproveAndCall.sol
...
// src/interfaces/IBeforeHook.sol
...
// src/interfaces/ICurveRouter.sol
...
// lib/swap-router-contracts/contracts/interfaces/IV2SwapRouter.sol
...
// lib/swap-router-contracts/contracts/interfaces/IMulticallExtended.sol
...
library TransferHelper {
    ...
    function safeTransferFrom(
        ...
        (bool success, bytes memory data) =
            token.call(abi.encodeWithSelector(IERC20_1.transferFrom.selector, from, to, value));
    ...
    function safeTransfer(
        ...
        (bool success, bytes memory data) = token.call(abi.encodeWithSelector(IERC20_1.transfer.selector, to, value));
    ...
    function safeApprove(
        ...
        (bool success, bytes memory data) = token.call(abi.encodeWithSelector(IERC20_1.approve.selector, to, value));
...
abstract contract AbstractYodlRouter {
    ...
    function sweep(address token) external {
        if (token == NATIVE_TOKEN) {
            ...
            TransferHelper.safeTransfer(token, yodlFeeTreasury, IERC20_1(token).balanceOf(address(this)));
        }
    }
...
// lib/swap-router-contracts/contracts/interfaces/ISwapRouter02.sol
...
// src/routers/YodlTransferRouter.sol
...
abstract contract YodlTransferRouter is AbstractYodlRouter {
    ...
    function yodlWithToken(YodlTransferParams calldata params) external payable returns (uint256) {
        ...
        if (params.token != NATIVE_TOKEN) {
            // ERC20 token
            require(IERC20_1(params.token).allowance(msg.sender, address(this)) >= finalAmount, "insufficient allowance");
        } else {
            // Native ether
...
// src/routers/YodlCurveRouter.sol
...
// src/routers/YodlUniswapRouter.sol
...
// src/chains/EthereumYodlRouter.sol
